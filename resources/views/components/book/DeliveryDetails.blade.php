                ...
                <form  class="needs-validation w-100" novalidate method="POST" action="{{route('HomeRemovals.DeliveryDetails_POST')}}">
                    ...
                    <div class="booking_details my-5 d-flex align-items-center flex-column">
                        <div class="content-wrapper  address-form w-1000">
                            ...
                            <div class="input-block postalcode" id="postcode_delivery"></div>

                            <div class="input-block">
                                <input type="text" name="address_1" id="formatted_address_0_delivery" class="form-control"  required  >
                                <span class="placeholder">
                                    Address Line 1
                                </span>
                            </div>
                            <div class="input-block">
                                <input type="text" name="address_2" id="formatted_address_1_delivery" class="form-control optional"   >
                                <span class="placeholder">
                                    Address Line 2
                                </span>
                            </div>
                            <div class="input-block">
                                <input type="text" name="city" class="form-control" id="town_or_city_delivery"  required  >
                                <span class="placeholder">
                                    City
                                </span>
                            </div>
