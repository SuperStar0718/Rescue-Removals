        ...
        <div class="col-md-8 men right_panel">
            <div class="d-flex justify-content-center ">
                ...
                <div class="men_count text-center minute d-flex flex-column justify-content-between poisition-relative">
                    ...
                    <div class="number_panel d-flex align-items-center bg-primary-light py-4 my-3" style="border-radius: 1.5rem;"><h1 class="text-white" style="font-size: 80px"> {{$result->men}}</h1></div>
