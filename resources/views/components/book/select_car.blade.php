    ...
    <div class="row">
        <div class="col-md-4 bg-primary-light d-flex justify-content-center align-items-center" style="border-radius: 2rem 0rem 0rem 2rem;">
            <div class="d-flex justify-content-center align-items-center">
                <h3 class="text-white description car_text_mobile">@if($component =='HomeRemovals.select_car')Here's the type of Van you will need.@else What type of Van will you need.@endif</h3>
            </div>                        
        </div>
