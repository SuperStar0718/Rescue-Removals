        ...
        <div class="col-md-8 men car right_panel">
            <div class="d-flex justify-content-center ">
                ...
                <div class="men_count text-center minute d-flex flex-column justify-content-between poisition-relative">
                    ...
                    <div class="number_panel d-flex align-items-center bg-primary-light my-3" style="border-radius: 2.5rem;"><h1 class="text-white" style="font-size: 146px">{{$result->number_of_car}}</h1></div>
