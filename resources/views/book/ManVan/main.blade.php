...
@section('content')
    ...
    <div class="bg-warning-light pt-3">
        <div class="container-content mar5 @if($component =="ManVan.select_car")select_car_mobile @endif">
            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between  py123 py-50 button-group display-none-sm">
                ...
                <div class="display-sm">
                    <div class="d-flex justify-content-between py-50 py123 button-group">
                        <a class="previous_button" href="{{route('ManVan.DeliveryDetails')}}"  id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Previous</h5>
                            </button>
                        </a>
                        <a href="{{route('ManVan.PaymentDetails')}}" class="" id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Next</h5>
                            </button>
                        </a>
            ...
            <div class="col-md-72  house_type">
                ...
                @switch($component)
                    ...
                    @case('ManVan.arrange_time')
                        ...
                        @break
                        @case('ManVan.BookingDetails')
                        @include('components.book.BookingDetails')
                        @php($next = "ManVan.PickupDetails")
                        @php( $previous = "ManVan.arrange_time")
                        @break
                    @case('ManVan.PickupDetails')
                        @include('components.book.PickupDetails')
                        @php($next = "ManVan.DeliveryDetails")
                        @php( $previous = "ManVan.BookingDetails")
                        @break
                    @case('ManVan.DeliveryDetails')
                        @include('components.book.DeliveryDetails')
                        @php($next = "ManVan.final_calculation")
                        @php( $previous = "ManVan.PickupDetails")
                        @break
                    @case('ManVan.PaymentDetails')
                ...
                <div class="d-flex justify-content-between py-50 button-group">
                    ...
                    @if($component == 'ManVan.arrange_time')
                        ...
                        <a href="{{route('ManVan.BookingDetails')}}" class="next_button display-sm" id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Next</h5>
                            </button>
                        </a>
            ...
            <div class="display-sm">
                <div class="bottom-buttons">
                    ...
                    @if($component!= 'ManVan.ViewItems' && $component!= 'ManVan')
                    <div class="view_item @if($component =='ManVan.select_car') select_car_veiw_item @endif" onclick="window.location.assign('{{route('ManVan.ViewItem')}}')">
...
@section('script')
<script>
    @if($component!='ManVan'  && isset($result))
...
@endif
@if($component=="ManVan.BookingDetails" || $component=="ManVan.PickupDetails" || $component=="ManVan.DeliveryDetails" )
<script>
    $('.next_button').click(function(e){
        e.preventDefault();
        $('.submit_hidden').click()
...
@if($component == "ManVan.PickupDetails" || $component == "ManVan.DeliveryDetails")
