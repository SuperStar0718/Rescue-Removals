            ...
            <div class="row">
                <div class="col-md-9">
                            ...
                            <div class="col-md-8">
                                <div class="d-flex justify-content-start py-5">
                                    <div class="text-center py-5">                                
                                        <img src="{{asset('images/man-courier.png')}}" alt="man-courier" style="width: 350px;">
                                    </div>
                                    <div class="text-center py-5 " >
                                        ...
                                        <div class="bg-primary-light px-5 py-4 my-3" style="border-radius: 1.5rem;"><h1 class="text-white" style="font-size: 150px">3</h1></div>
                                        <i class="fa fa-play pointer" style="color: white; background-color:#353EA3; border-radius:50%; padding:10px; transform: rotate(90deg);"></i>                          
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-between py-5">
                        <a href="{{ url('/furnitureappliance_manvan_eBaydeliveries/book2') }}" id="quote_url">
