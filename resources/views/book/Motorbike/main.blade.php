...
@section('content')
    ...
    <div class="bg-warning-light2 pt-3">
        <div class="container-content mar5 @if($component =="Motorbike.select_car")select_car_mobile @endif" >
            ...
            <div class="col-md-12">
                ...
                <div class="display-sm">
                    <div class="d-flex justify-content-between py-50 py123 button-group">
                        <a class="previous_button" href="{{route('Motorbike.DeliveryDetails')}}"  id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Previous</h5>
                            </button>
                        </a>
                        <a href="{{route('Motorbike.PaymentDetails')}}" class="" id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Next</h5>
                            </button>
                        </a>
            ...
            <div @if($component=="Motorbike.final_calculation" || $component=="Motorbike.billing" ) class="col-md-72" @else class="col-md-12" @endif>
                ...
                @switch($component)
                    ...
                    @case('Motorbike.arrange_time')
                        ...
                        @break
                    @case('Motorbike.BookingDetails')
                        @include('components.book.BookingDetails')
                        @php($next = "Motorbike.PickupDetails")
                        @php( $previous = "Motorbike.arrange_time")
                        @break
                    @case('Motorbike.PickupDetails')
                        @include('components.book.PickupDetails')
                        @php($next = "Motorbike.DeliveryDetails")
                        @php( $previous = "Motorbike.BookingDetails")
                        @break
                    @case('Motorbike.DeliveryDetails')
                        @include('components.book.DeliveryDetails')
                        @php($next = "Motorbike.final_calculation")
                        @php( $previous = "Motorbike.PickupDetails")
                        @break
                    @case('Motorbike.PaymentDetails')
                ...
                <div class="d-flex justify-content-between py-50 button-group">
                    ...
                    @if($component == 'Motorbike.arrange_time')
                        ...
                        <a href="{{route('Motorbike.BookingDetails')}}" class="next_button display-sm" id="quote_url">
                            <button type="submit" class="btn py-3 px-5 bg-primary-light text-white" style="border-radius: 0.5rem;">
                                <h5 class="mb-0">Next</h5>
                            </button>
                        </a>
...
@if($component == "Motorbike.PickupDetails" || $component == "Motorbike.DeliveryDetails")
...
@if($component=="Motorbike.BookingDetails" || $component=="Motorbike.PickupDetails" || $component=="Motorbike.DeliveryDetails" )
<script>
