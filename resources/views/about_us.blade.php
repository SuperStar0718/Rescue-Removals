...
<div class="display-sm">
    ...
    <div class="">
        <div class="container-content">
            <div class="py-4 display-none-sm" style="padding-top: 3rem !important;">
    ...
    <!--------------- section 2 --------------->
    <div class="container-content py-5 sevice_text_content" style="padding-top: 3rem !important; padding-bottom: 0rem !important;">
        <div>
            <p>
    ...
    <!--------------- section 4 --------------->
    <div class="container-content pt-5 sevice_text_content mar5" style="padding-top: 0rem !important;  ">
        <!--<div class="row">            -->
