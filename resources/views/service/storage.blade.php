...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center py-5">
                    <div class="text-center">
                        <h3 class="text-white">Storage</h3>
                        <div class="text-center">
                            <a href="{{ url('/') }}">
    ...
    <!--------------- section 2 --------------->
    <h4 class="container-content font-weight-bolder my-4">Storage</h4>
    <div class="bg-warning-light">
        <div class="container-content py-5">
            <div class="row">
                <div class="col-md-5">
                    <img src="{{asset('images/Storage/storage-1.png')}}" class="w-100">
                </div>
                <div class="col-md-7">
                    ...
                    <div>
                        <img src="{{asset('images/Storage/storage-2.png')}}" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-content">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-3.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-4.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-5.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-6.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-7.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Storage/storage-8.png')}}" class="w-100">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="moving-home bg-white position-relative p-5">
            <div class="row">
                <div class="col-md-9">
                    <div class="d-flex justify-content-center">
                        <div>
                            <h3  class="btn-text-primary-light">Need Storage?</h3>
                            <p>
