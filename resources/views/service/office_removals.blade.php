        ...
        <div class="container-content py-5">
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div>
                        <img src="{{asset('images/Office Removals/office-removals-2.png')}}" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-content">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-3.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-4.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-5.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-6.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-7.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Office Removals/office-removals-8.png')}}" class="w-100">
                </div>
            </div>
        </div>
    </div>
