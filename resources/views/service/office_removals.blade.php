...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center py-5">
                    <div class="text-center">
                        <h3 class="text-white">Office Removals</h3>
                        <div class="text-center">
                            <a href="{{ url('/') }}">
    ...
    <!--------------- section 2 --------------->
    <h4 class="container-content font-weight-bolder display-none-sm my-4">Office Removals</h4>
    <div class="bg-warning-light">
        <div class="container-content py-5 sevice_text_content">
            <div class="row">
                <div class="col-md-5 left_image">
                    <img src="{{asset('images/Office Removals/office-removals-1.png')}}" class="">
                </div>
                <div class="col-md-7 right_context">
                    ...
                    <div class="display-none-sm">
                        <img src="{{asset('images/Office Removals/office-removals-2.png')}}" class="img_wid_100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-10 service-container">
        ...
        <div class="container-content service_category services">
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-3.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-4.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-5.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-6.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-7.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Office Removals/office-removals-8.png')}}" class="">
                </div>
        </div>
    </div>
    <!--------------- end section 3 --------------->
            ...
            <div class="row book-now">
                    <div class="d-flex justify-content-center">
                        <div class="bottom-book-now">
                            <h3  class="btn-text-primary-light">Moving Office?</h3>
                            <p>
