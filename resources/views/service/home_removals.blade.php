...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center py-5">
                    <div class="text-center">
                        <h3 class="text-white">Home Removals</h3>
                        <div class="text-center">
                            <a href="{{ url('/') }}">
    ...
    <div class="bg-warning-light">
        <div class="container-content py-5">
            <div class="row">
                <div class="col-md-5">
                    <img src="{{asset('images/Home Removals/home-removals-1.png')}}" class="w-100">
                </div>
                <div class="col-md-7">
        ...
        <div class="container-content">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-3.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-4.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-5.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-6.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-7.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Home Removals/home-removals-8.png')}}" class="w-100">
                </div>
            </div>
        </div>
    </div>
