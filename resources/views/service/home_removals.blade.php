...
@section('content')
    ...
    <!--------------- section 2 --------------->
    <h4 class="container-content font-weight-bolder display-none-sm my-4">Home Removals</h4>
    ...
    <div class="py-10 service-container">
        ...
        <div class="container-content service_category services">
                ...
                <div class="">
                    <img src="{{asset('images/Home Removals/home-removals-4.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Home Removals/home-removals-5.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Home Removals/home-removals-6.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Home Removals/home-removals-7.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Home Removals/home-removals-8.png')}}" class="">
                </div>
        </div>
    </div>
    <!--------------- end section 3 --------------->
