...
@section('content')
    ...
    <!--------------- section 2 --------------->
    <h4 class="container-content font-weight-bolder my-4">Motorbikes</h4>
    <div class="bg-warning-light">
        <div class="container-content py-5">
            <div class="row">
                <div class="col-md-5">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-1.png')}}" class="w-100">
                </div>
                <div class="col-md-7">
                    ...
                    <div>
                        <img src="{{asset('images/Motorbikes/motorbike-removals-2.png')}}" class="w-100">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-content">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-3.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-4.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-5.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-6.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-7.png')}}" class="w-100">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{asset('images/Motorbikes/motorbike-removals-8.png')}}" class="w-100">
                </div>
            </div>
        </div>
    </div>
