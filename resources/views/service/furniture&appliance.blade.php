...
@section('content')
    ...
    <!--------------- section 2 --------------->
    <h4 class="container-content font-weight-bolder display-none-sm my-4">Furniture & Applicances</h4>
    <div class="bg-warning-light">
        <div class="container-content py-5 sevice_text_content">
            <div class="row">
                <div class="col-md-5 left_image">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-1.png')}}" class="">
                </div>
                <div class="col-md-7 right_context">
                    ...
                    <div class="display-none-sm">
                        <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-2.png')}}" class="img_wid_100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="py-10 service-container">
        ...
        <div class="container-content service_category services">
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-3.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-4.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-5.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-6.png')}}" class=""> 
                </div>
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-7.png')}}" class="">
                </div>
                <div class="">
                    <img src="{{asset('images/Furniture & Appliances/furniture-and-appliances-8.png')}}" class="">
                </div>
        </div>
    </div>
    <!--------------- end section 3 --------------->
